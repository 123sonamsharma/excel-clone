        ...
        $(".sheet-delete").click(function () {
            if(Object.keys(cellData).length > 1){
               ...
               currSheet.remove();
                ...
                alert("sorry there is only one sheet:not possible");
            }
        }) 
    ...
    $(".icon-paste").click(function() {
        ...
        for(let cell of selectedCells){
            ...
            if(!cellData[selectedSheet][newRowId]) {
                ...
                if(cut){
                   delete cellData[selectSheet][cell[0]][cell[1]] ;
                   if(Object.keys(cellData[selectSheet][cell[0]]).length == 0){
                       delete cellData[selectSheet][cell[0]];
                   }
                }
        }
        if(cut){
